...
interface IsPaidInvoicesProps {
  isPaidInvoices: InvoiceWithProductItems[] | undefined;
}
const IsPaidInvoices = ({ isPaidInvoices }: IsPaidInvoicesProps) => {
  if (!isPaidInvoices?.length) {
